...
func usage() {
    ...
    Flags:
      --output    Path of the .tiff to write (default: Packaging/dmg-background.tiff)
...
var output = "Packaging/dmg-background.tiff"
...
let temp = FileManager.default.temporaryDirectory
    .appendingPathComponent("brightsync-dmg-bg-\(ProcessInfo.processInfo.processIdentifier)")
